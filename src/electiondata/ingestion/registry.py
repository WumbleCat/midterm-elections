...
REGISTRY: dict[str, SourceSpec] = {
    ...
    for s in (
        ...
        SourceSpec(
            ...
            description="District-level House returns by candidate, cleaned by MEDSL.",
            normalized_table="election_results",
            ...
            known_limitations="Vote 'mode' rows are collapsed (TOTAL preferred, otherwise summed). Runoff rows are excluded from the general-election table.",
        ...
        SourceSpec(
            ...
            description="Land area in square miles for population density.",
            ...
            tested=True,
            options={"vintage": "Gazetteer year (default 2024)"},
        ),
        SourceSpec(
